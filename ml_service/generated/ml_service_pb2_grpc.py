...
class MLInferenceStub:
    ...
    def __init__(self, channel):
        ...
        self.Predict = channel.unary_unary(
                '/phantom_flow.ml.MLInference/Predict',
...
def add_MLInferenceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'phantom_flow.ml.MLInference', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('phantom_flow.ml.MLInference', rpc_method_handlers)
